...
out vec3 v3L2; // 輸出 Light Direction 在鏡頭座標下的方向
out vec3 v3L3; // 輸出 Light Direction 在鏡頭座標下的方向
out vec3 v3L4; // 輸出 Light Direction 在鏡頭座標下的方向
...
void main()
{
	...
	v3L2 = vec3(LightInView2.xyz - vPosInView.xyz);
	v3L3 = vec3(LightInView3.xyz - vPosInView.xyz);
	v3L4 = vec3(LightInView4.xyz - vPosInView.xyz);
