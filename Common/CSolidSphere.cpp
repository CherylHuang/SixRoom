...
void CSolidSphere::Update(float dt, const LightSource &Lights)	//一個光源
{
...
void CSolidSphere::Update(float dt, const LightSource &Lights, const LightSource &Lights2)	//兩個光源
{
	// Lighting With GPU
	if (m_bViewUpdated || m_bTRSUpdated) {
		m_mxMVFinal = m_mxView * m_mxTRS;
...
void CSolidSphere::Update(float dt, const LightSource &Lights, const LightSource &Lights2, const LightSource &Lights3)	//三個光源
{
	// Lighting With GPU
	if (m_bViewUpdated || m_bTRSUpdated) {
		m_mxMVFinal = m_mxView * m_mxTRS;
...
void CSolidSphere::Update(float dt, const LightSource &Lights, const LightSource &Lights2, const LightSource &Lights3, const LightSource &Lights4)	//四個光源
{
	// Lighting With GPU
	if (m_bViewUpdated || m_bTRSUpdated) {
		m_mxMVFinal = m_mxView * m_mxTRS;
